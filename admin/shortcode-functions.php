...
'Hover Shortcode Panel' => array(
    ...
    'description' => __('To get all features active, please buy the pro version here <a href="http://demo.wpeffects.com/amazing-hover-effects/">Amazing Hover Effects Pro</a> for only $11', 'vp_textdomain'),
    'status' => 'error',
    ),
					array(
						'type'  => 'textbox',
